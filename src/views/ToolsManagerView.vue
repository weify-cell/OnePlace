  ...
  <AppLayout>
    <div class="page">
      ...
      <n-modal v-model:show="showModal" preset="card" :title="editing ? '编辑工具' : '新建工具'" style="width:560px" :mask-closable="false">
        ...
        <template #footer>
          <n-space justify="end"><n-button @click="showModal = false">取消</n-button><n-button type="primary" @click="saveTool">保存</n-button></n-space>
        </template>
      </n-modal>
    </div>
  </AppLayout>
...
.card__label { font-size: 0.75rem; color: var(--accent-primary); background: rgba(245,158,11,.1); padding: 1px 8px; border-radius: 4px; align-self: flex-start; }
